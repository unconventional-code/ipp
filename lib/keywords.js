...
var Job_Template_and_Operation_attribute_names =
  Job_Template_attribute_names.concat(Object.keys(attributes["Operation"]));
var Printer_attribute_names = Object.keys(attributes["Job Template"]).concat([
  "none",
]);
...
keywords["job-accounting-sheets-type"] = keyword_name(["none", "standard"]);
...
keywords["job-hold-until-default"] = keyword_name(keywords["job-hold-until"]);
...
keywords["job-sheets-supported"] = setof_keyword_name(keywords["job-sheets"]);
...
keywords["media-color-supported"] = setof_keyword_name(keywords["media-color"]);
keywords["media-default"] = keyword_name_novalue(keywords["media"]);
keywords["media-front-coating"] = keyword_name(keywords["media-back-coating"]);
keywords["media-front-coating-supported"] = setof_keyword_name(
  keywords["media-back-coating"]
);
keywords["media-grain"] = keyword_name(["x-direction", "y-direction"]);
keywords["media-grain-supported"] = setof_keyword_name(keywords["media-grain"]);
keywords["media-input-tray-check"] = keyword_name([media["input tray"]]);
...
keywords["media-recycled-supported"] = keyword_name(keywords["media-recycled"]);
...
keywords["media-tooth-supported"] = setof_keyword_name(keywords["media-tooth"]);
...
keywords["media-type-supported"] = setof_keyword_name(keywords["media-type"]);
...
keywords["notify-events-default"] = setof_keyword(keywords["notify-events"]);
keywords["notify-events-supported"] = setof_keyword(keywords["notify-events"]);
...
keywords["job-accounting-output-bin"] = keyword_name(keywords["output-bin"]);
keywords["output-bin-default"] = keyword_name(keywords["output-bin"]);
keywords["output-bin-supported"] = setof_keyword_name(keywords["output-bin"]);
...
keywords["page-delivery-supported"] = setof_keyword(keywords["page-delivery"]);
...
keywords["sheet-collate-supported"] = setof_keyword(keywords["sheet-collate"]);
...
keywords["uri-security-supported"] = setof_keyword(["none", "ssl3", "tls"]);
...
keywords["which-jobs-supported"] = setof_keyword(keywords["which-jobs"]);
...
keywords["xri-security-supported"] = setof_keyword(["none", "ssl3", "tls"]);
